...
import { Container, Text, Slider, TextSection, Grid, FeatureCard, FAQ } from '@/components/slices';
...
export default function AdvertiseClient({ packages }: AdvertiseClientProps) {
